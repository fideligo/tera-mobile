      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.check_circle_outline, color: TeraColors.brand, size: 80),
              const SizedBox(height: TeraSpacing.xl),
              const Text(
                'Session accepted',
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: TeraText.section, fontWeight: FontWeight.bold, color: TeraColors.ink),
              ),
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              const Icon(Icons.compare_arrows, color: TeraColors.neutral500, size: 80),
              const SizedBox(height: TeraSpacing.xl),
              const Text(
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: const TextStyle(fontSize: TeraText.small, color: TeraColors.neutral500),
              ),
              ...
              FilledButton(
                ...
                child: const Text('Try again', style: TextStyle(fontSize: TeraText.body, color: TeraColors.paper, fontWeight: FontWeight.bold)),
              ),
              const SizedBox(height: TeraSpacing.md),
              TextButton(
                onPressed: onCancel,
                child: const Text('Back to home', style: TextStyle(fontSize: TeraText.body, color: TeraColors.ink, fontWeight: FontWeight.w600)),
              ),
            ],
          ),
        ),
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              const Icon(Icons.error_outline, color: TeraColors.neutral500, size: 80),
              const SizedBox(height: TeraSpacing.xl),
              const Text(
                'A few sessions haven\'t come through clearly',
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: TeraText.section, fontWeight: FontWeight.bold, color: TeraColors.ink, height: 1.2),
              ),
              const SizedBox(height: TeraSpacing.md),
              const Text(
              ...
              const Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: TeraText.body, color: TeraColors.neutral500, height: 1.4),
              ),
              const SizedBox(height: TeraSpacing.xxl),
              FilledButton(
                onPressed: onDone,
                ...
                child: const Text('Take a break', style: TextStyle(fontSize: TeraText.body, color: TeraColors.paper, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
        ),
